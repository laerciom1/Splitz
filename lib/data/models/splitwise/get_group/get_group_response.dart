...
class GetGroupResponse {
    ...
    factory GetGroupResponse.fromJson(String str) => GetGroupResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory GetGroupResponse.fromMap(Map<String, dynamic> json) => GetGroupResponse(
