...
class CreateExpenseResponse {
    ...
    factory CreateExpenseResponse.fromJson(String str) => CreateExpenseResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory CreateExpenseResponse.fromMap(Map<String, dynamic> json) => CreateExpenseResponse(
